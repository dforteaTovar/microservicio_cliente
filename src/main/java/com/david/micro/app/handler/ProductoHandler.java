...
import com.david.micro.app.models.service.ProductoService;

import reactor.core.publisher.Mono;

@Component
//Controlador del cliente que llama a nuestro servicio de productos
public class ProductoHandler {
	...
	public Mono<ServerResponse> upload (ServerRequest request){
		String id = request.pathVariable("id");
		return errorHandler(
				request.multipartData().map(mulltipart -> mulltipart.toSingleValueMap().get("file"))
					  .cast(FilePart.class)
